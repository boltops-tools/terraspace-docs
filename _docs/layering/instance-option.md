---
title: "Instance Option (Deprecated)"
nav_text: Instance Option
category: layering
order: 88
---
...
The `--instance` is option is deprecated in Terraspace v2 and will be removed. This docs will eventually be removed in favor of [Extra Docs]({% link _docs/layering/extra.md %})
