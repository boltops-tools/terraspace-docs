...
When you run `terraspace` commands, it will use the files in the config folder and materialized them withdeployed module.  For example, let's say you have an `app/stacks/wordpress` stack:
