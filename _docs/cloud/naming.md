...
Terraform suggestions "One Workspace Per Environment Per Terraform Configuration". This also means if you want to deploy to another region, you should scope the TFC Workspace name to include the region. Then Terraspace workspace naming scheme accounts for all of this.
